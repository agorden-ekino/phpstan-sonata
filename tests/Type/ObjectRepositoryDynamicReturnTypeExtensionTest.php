...
class ObjectRepositoryDynamicReturnTypeExtensionTest extends TestCase
{
    ...
    public function testIsMethodSupported(bool $expected, string $methodName): void
    {
        ...
        $extendedMethodReflection->expects($this->once())->method('getName')->willReturn($methodName);

        $this->assertSame($expected, $this->extension->isMethodSupported($extendedMethodReflection));
    }
